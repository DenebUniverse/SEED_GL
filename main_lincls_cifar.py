...
def main():
    ...
    logger = setup_logger(output=args.output, color=False,name="SEED Linear Evaluation")
    # if dist.get_rank() == 0:
...
def main_worker(args, logger):
    ...
    val_loader=torchvision.datasets.CIFAR100(root='../../data/cifar-100-python/', train=False,
                                                  transform=transforms.Compose([
                                                    transforms.Resize(256),
                                                    transforms.CenterCrop(224),
                                                    transforms.ToTensor(),
